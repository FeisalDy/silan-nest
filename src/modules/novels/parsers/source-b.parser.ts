...
//     return (
//       SourceBParser.TITLE_RE.test(text) ||
//       SourceBParser.AUTHOR_RE.test(text) ||
//       SourceBParser.SYNOPSIS_START_RE.test(text) ||
//       SourceBParser.CHAPTER_HEADING_RE.test(text)
//     );
//   }
//
